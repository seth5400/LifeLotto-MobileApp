...
class PPAdapter(
    ...
    private val listDataChild: HashMap<String, List<PPItem>>
    ...
    override fun getGroupView(
        ...
        val view = convertView ?: View.inflate(context, R.layout.list_item_pp_group, null)
    ...
    override fun getChildView(
        ...
        val childText = (getChild(groupPosition, childPosition) as PPItem).answer
        val view = convertView ?: View.inflate(context, R.layout.list_item_pp_child, null)
